...
plot.PCA(res.pca1984,choix='var',habillage = 'contrib',title="Círculo de correlaciones para 1984")
```


```{r,fig.cap= "Dimensiones 3 y 4."}
plot.PCA(res.pca1984,choix = "var",axes=c(3,4),habillage='cos2', title = "Círculo de correlaciones para 1984")
```
...
```{r, fig.cap="Dimensiones 1 y 2."}
plot.PCA(res.pca1984,choix = "ind",title="Gráfico perspectiva de Países 1984",habillage = "co2")
```
...
```{r, fig.cap="Dimensiones 3 y 4."}
plot.PCA(res.pca1984,axes=c(3,4),title="Gráfico perspectiva de Países 1984",habillage = "co2")
```
...
```{r criterio BS 1996, fig.="Criterio Broken-sticks para la elección de componentes",cache=TRUE}
evplot(vp96[,1])
```
