...
```{r, fig.cap="Dimensiones 1 y 2."}
plot.PCA(res.pca1984,choix = "ind",title="Gráfico perspectiva de Países 1984",col.ind='#ED1536')
```
...
```{r, fig.cap="Dimensiones 3 y 4."}
plot.PCA(res.pca1984,axes=c(3,4),title="Gráfico perspectiva de Países 1984",col.ind='#ED1536')
```
...
Para el año 1996, observamos que se mantienen las correlaciones altas (>0.80) detectadas por 1984. Se suman al listado la relación negativa entre la oferta secundaria de energía per-cápita y la proporción de consumo residencial.
...
El criterio *"Broken-sitcks"* en cambio, sugiere retener 3 componentes:
...
```{r, fig.cap= "Dimensiones 1 y 2."}
plot.PCA(res.pca1996,choix='var',habillage = 'contrib',title="Círculo de correlaciones para 1996")
```


```{r,fig.cap= "Dimensiones 3 y 4."}
plot.PCA(res.pca1996,choix = "var",axes=c(3,4),habillage='cos2', title = "Círculo de correlaciones para 1996")
```
...
```{r, fig.cap="Dimensiones 1 y 2."}
plot.PCA(res.pca1996,choix = "ind",title="Gráfico perspectiva de Países",col.ind='#ED1536')
```
...
```{r, fig.cap="Dimensiones 3 y 4."}
plot.PCA(res.pca19966,axes=c(3,4),title="Gráfico perspectiva de Países",col.ind='#ED1536')
```
