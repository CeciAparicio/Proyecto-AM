...
knitr::opts_chunk$set(echo = FALSE,warning = FALSE,message = FALSE,fig.align = "center",results = "hold")
``` 
...
```{r, fig.align="left",results='hold'}
kable(unique(pais), booktabs=TRUE,caption = "Países considerados")
```
...
```{r summary de las variables originales va en anexos, fig.align='center',fig.cap= "Descripción de la base de datos"}
...
```{r summary de ACP, va en anexos,fig.align='center',fig.cap="ACP. Resultados principales para 1984"}
(summary(res.pca1984))
```

```{r, va en anexos,fig.align='center',fig.cap="ACP. Resultados principales para 1984"}
(summary(res.pca1996))
```
