...
```{r plot eigen84}
ggplot(a,aes(x=seq(1:14),y=eigenvalue))+ ##mejorar el gráfico
  geom_line()+
...
```{r criterio BS 1984, include=FALSE, fig.cap="Criterio Broken-sticks para la elección de componentes"}
...
Una vez determinado, de forma preliminar, la dimensión en que se trabajará, realizamos el cálculo de componentes y su presentación gráfica. 
...
```{r, fig.cap="Dimensiones 1 y 2."}
plot.PCA(res.pca1984,habillage='co2',title="Gráfico perspectiva de Países",col.ind='#ED1536')
```
...
```{r, fig.cap="Dimensiones 3 y 4."}
plot.PCA(res.axes=c(3,4),pca1984,habillage='co2',title="Gráfico perspectiva de Países",col.ind='#ED1536')
```
